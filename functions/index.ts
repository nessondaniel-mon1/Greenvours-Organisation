...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    ...
    pass: functions.config().email.pass, // Your Gmail app password
  },
});
...
export const sendNotification = functions.https.onCall(async (request, context: functions.https.CallableContext) => {
  ...
  const { itemType, item, action } = request.data as NotificationPayload;
